...
public class Main_fragment2 extends Fragment {
    ...
    public void onResume() {
        ...
        if(getArguments() != null){
            ...
            System.out.println("fragment2_leftSec : "+leftSec);
            System.out.println("fragment2_date : "+date);
            System.out.println("fragment2_title : "+title);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        linear1 = (LinearLayout) root.findViewById(R.id.fragment2_linear1);
        linear2 = (LinearLayout) root.findViewById(R.id.fragment2_linear2);
        tv_year = (TextView) root.findViewById(R.id.tv_year2);
        tv_month = (TextView) root.findViewById(R.id.tv_month2);
        tv_day = (TextView) root.findViewById(R.id.tv_day2);
        tv_left_year = (TextView) root.findViewById(R.id.tv_leftYear2);
        tv_left_day = (TextView) root.findViewById(R.id.tv_leftDay2);
        tv_left_hour = (TextView) root.findViewById(R.id.tv_leftTime2);
        tv_left_min = (TextView) root.findViewById(R.id.tv_leftMin2);
        tv_left_sec = (TextView) root.findViewById(R.id.tv_leftSec2);
        tv_info_gone = (TextView) root.findViewById(R.id.tv_infoGone2);
        tv_title = (TextView) root.findViewById(R.id.tv_title2);
        return root;
    }

    public static Main_fragment2 getInstance(int leftSec, String date, String title) {
        Main_fragment2 main_fragment2 = new Main_fragment2();
        Bundle args = new Bundle();
        args.putInt("leftSec", leftSec);
        args.putString("date", date);
        args.putString("title", title);
        main_fragment2.setArguments(args);
    ...
    private class CountDownTask extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            ...
            // 값 잘 넘어오는지 테스트 (성공 확인)
            System.out.println("fragment2_year : " + year);
            System.out.println("fragment2_day : " + day);
            System.out.println("fragment2_hour : " + hour);
            System.out.println("fragment2_min : " + min);
            System.out.println("fragment2_sec : " + sec);

            System.out.println("fragment2_dateArr[0] : " + dateArr[0]);
            System.out.println("fragment2_dateArr[1] : " + dateArr[1]);
            System.out.println("fragment2_dateArr[2] : " + dateArr[2]);
        ...
        protected void onProgressUpdate(Integer... values) {
            System.out.println("called fragment2 onProgressUpdate()");

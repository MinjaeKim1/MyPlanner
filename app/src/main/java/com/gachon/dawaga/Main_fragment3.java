...
public class Main_fragment3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_main_fragment3,container,false);
        linear1 = (LinearLayout) root.findViewById(R.id.fragment3_linear1);
        linear2 = (LinearLayout) root.findViewById(R.id.fragment3_linear2);
        tv_year = (TextView) root.findViewById(R.id.tv_year3);
        tv_month = (TextView) root.findViewById(R.id.tv_month3);
        tv_day = (TextView) root.findViewById(R.id.tv_day3);
        tv_left_year = (TextView) root.findViewById(R.id.tv_leftYear3);
        tv_left_day = (TextView) root.findViewById(R.id.tv_leftDay3);
        tv_left_hour = (TextView) root.findViewById(R.id.tv_leftTime3);
        tv_left_min = (TextView) root.findViewById(R.id.tv_leftMin3);
        tv_left_sec = (TextView) root.findViewById(R.id.tv_leftSec3);
        tv_info_gone = (TextView) root.findViewById(R.id.tv_infoGone3);
        tv_title = (TextView) root.findViewById(R.id.tv_title3);
        return root;
    }
    ...
    public void onResume() {
        ...
        if(getArguments() != null){
            ...
            System.out.println("fragment3_leftSec : "+leftSec);
            System.out.println("fragment3_date : "+date);
            System.out.println("fragment3_title : "+title);
    ...
    public static Main_fragment3 getInstance(int leftSec, String date, String title) {
        Main_fragment3 main_fragment3 = new Main_fragment3();
        Bundle args = new Bundle();
        args.putInt("leftSec", leftSec);
        args.putString("date", date);
        args.putString("title", title);
        main_fragment3.setArguments(args);
        return main_fragment3;
    }
    ...
    private class CountDownTask extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            ...
            // 값 잘 넘어오는지 테스트 (성공 확인)
            System.out.println("fragment3_year : " + year);
            System.out.println("fragment3_day : " + day);
            System.out.println("fragment3_hour : " + hour);
            System.out.println("fragment3_min : " + min);
            System.out.println("fragment3_sec : " + sec);

            System.out.println("fragment3_dateArr[0] : " + dateArr[0]);
            System.out.println("fragment3_dateArr[1] : " + dateArr[1]);
            System.out.println("fragment3_dateArr[2] : " + dateArr[2]);
